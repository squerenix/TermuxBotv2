...
exports.rediregis = () => {
	return`「 ❗ 」Kamu Sudah Terdaftar Di Database QIQI-BOT`
}
...
exports.bug = () => {
	return`「 ❗ 」Masalah Telah Dilaporkan Ke Owner Dilanツ, Laporan Palsu/Main Main Auto Block + Ban Permanent`
}
